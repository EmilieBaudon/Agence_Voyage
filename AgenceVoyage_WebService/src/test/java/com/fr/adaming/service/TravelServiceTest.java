...
public class TravelServiceTest {
	...
	public void a_createNewTravel() {
		// Create a new Travel
		createdTravel = new Travel(5, "Bora-Bora", LocalDate.of(2020, 05, 10), null, null, null,
				null);
	...
	public void c_createTravelWithNullId() {
		...
		createdTravel = new Travel(5, "Bora-Bora", LocalDate.of(2020, 05, 10), LocalDate.of(2018, 06, 28), null, null,
				null);
	...
	public void e_createTravelWithNullDestination() {
		...
		createdTravel = new Travel(5, null, LocalDate.of(2020, 05, 10), null, null, null, null);
		createdTravel = service.create(createdTravel);
	}
	...
	public void k_deleteExistingTravelId() {
		...
		Travel createdTravel = new Travel(5, "Bora-Bora", LocalDate.of(2020, 05, 10), null, null,
				null, null);
		createdTravel = service.create(createdTravel);
